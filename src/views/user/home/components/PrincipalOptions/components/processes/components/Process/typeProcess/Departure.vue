    ...
    <div style="width:100vw; height:85vh; overflow:scroll">
      ...
      <ion-list style="padding:0 !important">
        ...
        <ion-item lines="none">
          <ion-label text-wrap>
            <div>
              <h1 class="red-primary-text">Entrada</h1>
              ...
              <ion-button
                ...
                text-wrap
              >Esperando confirmación de Entrada</ion-button>
              <ion-button
                expand="block"
                disabled
                v-else-if="process.budgetConfirmed"
                text-wrap
              >Entrada Confirmada</ion-button>-->
              <ChangeStep
...
import PrintDeparture from "./components/PrintDeparture";
...
export default {
  ...
  methods: {
    ...
    getCreatedBy() {
      var vm = this;
      console.log(vm.process.createdBy);
